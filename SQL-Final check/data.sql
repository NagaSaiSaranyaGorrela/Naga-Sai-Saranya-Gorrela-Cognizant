...
select me_name,me_free_delivery,me_price from menu_item where me_id IN (select ct_pr_id from cart where ct_us_id IN (select us_id from users where us_name='sai'))
